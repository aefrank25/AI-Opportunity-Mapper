...
- For inferred assumptions, use hedged phrasing: "appears to be", "centered around", "focused on", "the scanned pages indicate", "public website signals suggest", "likely serves", "likely", or "may".
- Avoid overly certain wording: "This business is…", "They offer…", "The company has…", "Customers do…". Prefer "appears to be…", "centered around…", "focused on…", "the site presents…", "public website signals suggest…", "the scanned pages indicate…".
- Avoid "specializing in" unless the exact wording is directly supported by scanned page language. Prefer "appears to be", "centered around", "focused on", or "the site presents" instead.
...
- snapshot.summary MUST be 1-2 sentences and MUST start with "Based on public website signals, this appears to be…". Use a dynamic business category inferred from signals (see LANGUAGE RULES). Describe website-visible offerings with "The site presents…", "centered around…", "focused on…", or "The scanned pages mention…". Do not use "specializing in" unless directly supported by scanned page language. No unsupported narrow labels.
- snapshot.audience MUST contain 2-4 audience entries phrased cautiously with "Likely audience:" or "Potential audience:" prefixes (e.g. "Likely audience: individual buyers and gift shoppers", "Potential audience: small businesses seeking custom work"). Infer from product/service signals, tone, CTAs, navigation, and positioning even if the site does not explicitly name an audience. Append a final entry "Confidence: low", "Confidence: medium", or "Confidence: high" reflecting signal strength. Use "Confidence: high" ONLY when the audience is explicitly named or strongly repeated across scanned pages (e.g. a dedicated "For [audience]" page, repeated direct address, or explicit customer-type labels). Use "Confidence: medium" whenever the audience is inferred from products, services, CTAs, navigation, or other scanned website content rather than explicitly named. Use "Confidence: low" only when signals are weak or limited. When in doubt between medium and high, choose medium. Never leave audience empty.`;
