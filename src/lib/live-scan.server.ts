...
- snapshot.audience MUST contain 2-4 audience entries phrased cautiously with "Likely audience:" or "Potential audience:" prefixes (e.g. "Likely audience: individual buyers and gift shoppers", "Potential audience: small businesses seeking custom work"). Infer from product/service signals, tone, CTAs, navigation, and positioning even if the site does not explicitly name an audience. Append a final entry "Confidence: low", "Confidence: medium", or "Confidence: high" reflecting signal strength — use "high" ONLY when the audience is explicitly named or strongly repeated across scanned pages; use "medium" when the audience is inferred from products, services, CTAs, or navigation; use "low" when signals are weak or limited. Never leave audience empty.`;
