...
export const Route = createFileRoute("/results")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Your prioritized AI opportunity map: top recommendation, quick wins, and a starter roadmap preview.",
      },
      { property: "og:title", content: "Opportunity map — AI Opportunity Mapper" },
      { property: "og:description", content: "A prioritized AI opportunity map with top recommendation, quick wins, and a starter roadmap preview." },
      { name: "twitter:title", content: "Opportunity map — AI Opportunity Mapper" },
      { name: "twitter:description", content: "A prioritized AI opportunity map with top recommendation, quick wins, and a starter roadmap preview." },
    ],
  }),
