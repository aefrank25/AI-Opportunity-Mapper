...
export const Route = createFileRoute("/results")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "A prioritized AI opportunity map with top recommendation, quick wins, and a 30-day roadmap." },
      { name: "twitter:title", content: "Opportunity map — AI Opportunity Mapper" },
      { name: "twitter:description", content: "A prioritized AI opportunity map with top recommendation, quick wins, and a 30-day roadmap." },
    ],
  }),
